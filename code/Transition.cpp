...
int main(int argc, char **argv)
{
    try
    {
        ...
        // quantum espresso parameters, you cannot modify it
        ...
        // this 18.895 should be same with quantum espresso input
        // xy grid also
        // but their absolute position does not matter
        // z = 10 angstrom => 18.895 atmoic unit
...
#pragma omp parallel for collapse(2) schedule(static)
                            ...
                            outfile << "S " << m << "," << n << " band f = " << fst << ", band m = " << mst << ": (" << std::real(F_S_fm) << "," << std::imag(F_S_fm) << ")\n";
